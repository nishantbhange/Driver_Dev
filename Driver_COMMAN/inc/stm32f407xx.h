...
#define GPIOJ_PCKL_EN  (RCC->RCC_AHBENR[0] |=(1<<9))
#define GPIOK_PCKL_EN  (RCC->RCC_AHBENR[0] |=(1<<10))
...
#define SPI4_PCLK_EN (RCC->RCC_APBENR[1] |=(1<<13));
#define SPI5_PCLK_EN (RCC->RCC_APBENR[1] |=(1<<20));
#define SPI6_PCLK_EN (RCC->RCC_APBENR[1] |=(1<<21));
